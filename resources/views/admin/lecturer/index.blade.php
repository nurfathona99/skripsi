        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            {!! Form::open(['role' => 'form', 'route' => 'admin.dosen', 'method' =>'get']) !!}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-warning btn-sm" href="{{ route('admin.dosen.edit', $lecturer->id) }}">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    {!! Form::model($lecturer, ['route' => ['admin.dosen.delete', $lecturer->id], 'onclick' => 'return confirm("Anda Yakin?");']) !!}

<script type="text/javascript">
    ...
    $( "#form-register").validate({
      rules: {
        ...
        namecourses : {
            remote: {
                url: "{{ route('ajax.matakuliah.name') }}",
                type: "GET",
                data: {
        ...
        code_courses : {
            remote: {
                url: "{{ route('ajax.matakuliah.code') }}",
                type: "GET",
                data: {
        ...
        namerooms : {
         ...
         courses : {
            remote: {
                 url: "{{ route('ajax.mengajar.matakuliah') }}",
                 type: "GET",
                 data: {

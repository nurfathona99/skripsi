        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <?php echo Form::open(['role' => 'form', 'route' => 'admin.dosen', 'method' =>'get']); ?>
                                    ...
                                    <thead>
                                        <tr class="info">
                                           ...
                                           <th colspan="2" style="text-align:center;">
                                                <a class="btn btn-primary" href="<?php echo e(route('admin.dosen.create')); ?>">
                                                    <i class="fa fa-plus">
                                                    </i>
                                                    Tambah Data
                                                </a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-warning btn-sm" href="<?php echo e(route('admin.dosen.edit', $lecturer->id)); ?>">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <?php echo Form::model($lecturer, ['route' => ['admin.dosen.delete', $lecturer->id], 'onclick' => 'return confirm("Anda Yakin?");']); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\laragon\www\Penjadwalan\resources\views/admin/lecturer/index.blade.php ENDPATH**/ ?>
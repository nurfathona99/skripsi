                                    ...
                                    <thead>
                                        <tr class="info">
                                            ...
                                            <th colspan="2" style="text-align:center;">
                                                <a class="btn btn-primary" href="<?php echo e(route('admin.waktu.create')); ?>">
                                                    <i class="fa fa-plus">
                                                    </i>
                                                    Tambah Data
                                                </a>
                                     ...
                                     <?php $__currentLoopData = $times; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-warning btn-sm" href="<?php echo e(route('admin.waktu.edit', $time->id)); ?>">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <?php echo Form::model($time, ['route' => ['admin.waktu.delete', $time->id], 'onclick' => 'return confirm("Anda Yakin?");']); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\laragon\www\Penjadwalan\resources\views/admin/time/index.blade.php ENDPATH**/ ?>
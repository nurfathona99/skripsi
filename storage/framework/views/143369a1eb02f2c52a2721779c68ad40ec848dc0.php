<script type="text/javascript">
    ...
    $( "#form-register").validate({
      rules: {
        ...
        emaillecturer : {
            remote: {
                url: "<?php echo e(route('ajax.dosen.email')); ?>",
                type: "GET",
                data: {
        ...
        nidnlecturer : {
            remote: {
                url: "<?php echo e(route('ajax.dosen.nidn')); ?>",
                type: "GET",
                data: {
        ...
        namecourses : {
            remote: {
                url: "<?php echo e(route('ajax.matakuliah.name')); ?>",
                type: "GET",
                data: {
        ...
        code_courses : {
            remote: {
                url: "<?php echo e(route('ajax.matakuliah.code')); ?>",
                type: "GET",
                data: {
        ...
        code_rooms : {
            remote: {
                url: "<?php echo e(route('ajax.ruangan.code')); ?>",
                type: "GET",
                data: {
        ...
        namerooms : {
            remote: {
                url: "<?php echo e(route('ajax.ruangan.name')); ?>",
                type: "GET",
                data: {
         ...
         courses : {
            remote: {
                 url: "<?php echo e(route('ajax.mengajar.matakuliah')); ?>",
                 type: "GET",
                 data: {
...
<?php /**PATH E:\Data\laragon\www\Penjadwalan\resources\views/admin/_partials/js.blade.php ENDPATH**/ ?>